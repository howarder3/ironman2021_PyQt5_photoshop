...
# __init__.py make a folder like a module.

# from method.opencv_engine import opencv_engine
# don't care about __init__.py, is absolute path

# import method 
# usage: method.opencv_engine
# or opencv_engine = method.opencv_engine # not good 

# from method import * # need add  opencv_engine in __all__ of __init__.py in method folder

from method import opencv_engine 
# we can do this, we didn't add opencv_engine in __all__ of __init__.py in method folder,
# but we import opencv_engine in the  __init__.py
